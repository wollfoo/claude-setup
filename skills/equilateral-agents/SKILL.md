...
description: Multi-agent orchestration system sử dụng Claude subagents thực tế từ thư mục agents/ cho security reviews, code quality analysis, deployment validation, infrastructure checks. Auto-activates với orchestrator-worker pattern và extended thinking mode.
allowed-tools: Task, Read, Bash, Glob, Grep, WebSearch, mcp7_sequentialthinking, mcp5_create_entities
version: 2.0.0
---
